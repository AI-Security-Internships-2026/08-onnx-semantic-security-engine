...
I am interested in this project because it sits at the
...
### What I Learned
- What ONNX is and why it enables model portability across frameworks
  and hardware targets
- What a semantic security engine does differently from signature-based
  intrusion detection systems
- Why edge inference constraints (memory, latency, compute) shape every
...
- [ ] What type of threat data will we primarily work with — network
      traffic features, raw logs, or both?
- [ ] What is the primary target edge device (Raspberry Pi 4, Jetson Nano,
      or other)?
